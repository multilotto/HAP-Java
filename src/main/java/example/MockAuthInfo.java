...
/**
 * This is a simple implementation that should never be used in actual production. The mac, salt,
 * and privateKey are being regenerated every time the application is started. The user store is
 * also not persisted. This means pairing needs to be re-done every time the app restarts.
 *
 * @author Andy Lintner
 */
